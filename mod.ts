...
function remove(el: Element) {
  ...
  const finalX = globalThis.window.scrollX
  const finalY = globalThis.window.scrollY
...
function adjustScroll(
  ...
  globalThis.window.scrollTo(globalThis.window.scrollX + scrollDeltaX, globalThis.window.scrollY + scrollDeltaY)
      ...
      if (!isPlugin(optionsOrPlugin)) {
        ...
        if (startScroll + optionsOrPlugin.duration > performance.now()) {
          globalThis.window.scrollTo({
            left: globalThis.window.scrollX - deltaX!,
            top: globalThis.window.scrollY - deltaY!,
          })
